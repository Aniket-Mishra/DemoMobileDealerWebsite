        ...
        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder=" description" value="">Well, Whatever _-_</textarea>
                      </div>
                    </div>
                  </div>
                </form>
          ...
          <div class="col-md-4">
            <div class="card card-user">
              <div class="image">
                <img src="" alt="">
                <span>Image is supposed to be here </span>
              </div>
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="" alt="">
                    <h5 class="title">Name _-_</h5>
                  </a>
                  <p class="description">
                    ljlsnLALND
                  </p>
